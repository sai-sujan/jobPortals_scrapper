#!/usr/bin/env python3
"""Open filtered Judge Group job pages in the existing browser."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Open Judge Group job pages in browser tabs.")
    parser.add_argument("--jobs-file", type=Path, help="Filtered judgegroup_jobs_*.json. Defaults to latest output.")
...
def main() -> int:
    ...
    print(f"Opening {len(selected)} Judge Group tabs...")
